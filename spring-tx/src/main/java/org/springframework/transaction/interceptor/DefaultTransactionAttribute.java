...
public class DefaultTransactionAttribute extends DefaultTransactionDefinition implements TransactionAttribute {
	 ...
	 * todo 回滚条件
	 * todo 默认情况下Spring中的事务异常处理机制只对RuntimeException和Error两种情况感兴趣，
	 * todo 当然你可以通过扩展来改变，不过，我们最常用的还是使用事务提供的属性设置. 利用注解方式的使用，例如：
	  todo @Transactional(propsgation=Propagation_REQUIRED,rollbackFor=Exception.class)
	 */
	@Override
