 ...
 * @since 2.0
 * todo <tx:ann tation-driven transaction-manager ="transactionManager ”/>
 * <bean id transacti nManager
class= “org.Springframework.jdbc.datasource.DataSourceTransactionManager"
<property name= dataSource ref =dataSourcε/>
</bean>
 */
public class TxNamespaceHandler extends NamespaceHandlerSupport {
	...
	/**
	 * todo 此方法会在DefaultNamespaceHandlerResolver类的resolve方法中被调用
	 */
	@Override
	public void init() {
		registerBeanDefinitionParser("advice", new TxAdviceBeanDefinitionParser());
		//todo AnnotationDrivenBeanDefinitionParser 的 parse处理
