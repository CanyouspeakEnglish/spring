...
public class AnnotationTransactionAttributeSource extends AbstractFallbackTransactionAttributeSource
	...
	/**
	 * todo 是在AnnotationTransactionAttributeSource初始化的时候初始化的 其中的值被加入了SpringTransactionAnnotationParser
	 * todo 进行属性获取的时候使用SpringTransactionAnnotationParser类的parseTransactionAnnotation方法解析
	 */
	...
	/**
	 * todo 搜寻事务属性的任务委托给findTransactionAttribute方法执行
	 ...
	 * todo  SpringTransactionAnnotationParser 搜寻事务属性的任务委托给findTransactionAttribute方法执行
	 */
	@Nullable
