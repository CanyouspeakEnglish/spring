...
public abstract class JdbcTransactionObjectSupport implements SavepointManager, SmartTransactionObject {
	 ...
	 * todo 当之前已经保存的事务信息中的事务为新事物，那么直接回滾.常用于单独事务的处理。
	 * todo 对于没有保存点的回滾,Spring同样是使用底层敷据库连接提供的API来操作的。由于我们使用的是
	 * todo DataSourceTransactionManager,那么doRollback函数会使用此类中的实现
	 */
	@Override
